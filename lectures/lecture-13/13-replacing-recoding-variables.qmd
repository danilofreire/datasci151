---
title: DATASCI 151 - Intro to Statistical Programming II
...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Variables](https://raw.githack.com/danilofreire/datasci151/main/lectures/lecture-13/13-replacing-recoding-variables.html)"
transition: slide
...
#| echo: true
#| eval: true
circuits = pd.read_csv("https://github.com/danilofreire/datasci151/raw/refs/heads/main/lectures/lecture-13/data_raw/circuits.csv")
...
- The dataset is available in the course's GitHub repository [here](https://github.com/danilofreire/datasci151/blob/main/lectures/lecture-13/data_raw/circuits.csv)
