...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Variables and Lists](https://raw.githack.com/danilofreire/datasci151/main/lectures/lecture-03/03-variables-lists.html)"
...
:::{.columns}
:::{.column width="50%"}
- Open the [`03-variables-lists.ipynb`](https://github.com/danilofreire/datasci151/blob/main/lectures/lecture-03/03-variables-lists.ipynb) notebook in VS Code (or create your own)
