...
format:
  clean-revealjs:
    self-contained: true
    footer: "[GitHub Review](https://danilofreire.github.io/datasci151/lectures/lecture-02/02-github-review.html)"
transition: slide
...
- Please check the tutorials on the course repository: <https://github.com/danilofreire/datasci151/tutorials>. They will help you with the installation and setup of the software. 
...
- Example repo: <https://github.com/danilofreire/datasci151-example-repository>
...
- We can fork the repo using the GitHub page
  ...
  - See the [GitHub Tutorial](https://github.com/danilofreire/datasci151/blob/main/tutorials/03-github-tutorial.pdf) for more details
:::
:::
