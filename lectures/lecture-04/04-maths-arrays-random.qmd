...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Maths with NumPy](https://raw.githack.com/danilofreire/datasci151/main/lectures/lecture-04/04-maths-arrays-random.html)"
transition: slide
...
:::{.column width="50%"}
- [Assignment 01](https://github.com/danilofreire/datasci151/blob/main/assignments/02-assignment.ipynb) is due today! 🚨
- Assignment 02 is already online on Canvas and [GitHub](https://github.com/danilofreire/datasci151/blob/main/assignments/02-assignment.ipynb)
