...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Subsetting Data](https://raw.githack.com/danilofreire/datasci151/main/lectures/lecture-11/11-subsetting-data.html)"
...
- [Download the dataset](https://github.com/danilofreire/datasci151/blob/main/lectures/lecture-11/data_raw/features.csv) if you don't have it (click on `Download Raw File`)
