...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Introduction to SQL with SQLite](https://raw.githack.com/danilofreire/qtm151/main/lectures/lecture-17/17-introduction-sql.html)" # Updated footer link
transition: slide
