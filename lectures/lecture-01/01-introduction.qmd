...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Lecture 01](https://danilofreire.github.io/datasci151/lectures/lecture-01/01-introduction.html)"
...
# Welcome to DATASCI 151 - Introduction to Statistical Computing II! `{r} emo::ji('partying_face')` `{r} emo::ji('tada')` {background-color="#2d4563"}
...
`r fa('github')` Course repository: <https://github.com/danilofreire/datasci151>

`r fa('globe')` Course website: <https://danilofreire.github.io/datasci151>
...
public class Welcome {
    public static void main(String[] args) {
        System.out.println("Welcome to DATASCI151!");
    }
}
...
- Follow the instructions [on our GitHub repository](https://github.com/danilofreire/datasci151/blob/main/tutorials/01-vscode-anaconda-tutorial.pdf) 
...
- Follow the instructions [Installing Visual Studio Code and Connecting it with Anaconda](https://github.com/danilofreire/datasci151/blob/main/tutorials/01-vscode-anaconda-tutorial.pdf) from GitHub
...
- Next step: we will create a new folder for the DATASCI151 course and download our virtual GitHub folder and opening it in VSCode
...
::: {.column width=30%}
::: {style="font-size: 26px;"}
- We will use Jupyter Notebooks for our classes. We have [a tutorial on how to use them too](https://github.com/danilofreire/datasci151/blob/main/tutorials/02-jupyter-markdown-tutorial.pdf)
...
- Please remember to check the course repository, mainly the tutorials: <https://github.com/danilofreire/datasci151> 
